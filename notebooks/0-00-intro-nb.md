...
on suppose [les installations faites lors du cours d'introduction](https://intro.info-mines.paris/1-1-installations/) (bash - vscode - conda - jupyter - jupytext - git)
...
si vous voulez essayer d'utiliser ce système, [voyez cette page dans le cours d'introduction](https://intro.info-mines.paris/3-3-virtual-envs/)
